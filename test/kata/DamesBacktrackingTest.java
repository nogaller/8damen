...
public class DamesBacktrackingTest {

	@Test
	public void nextBorder() throws Exception {
		DamesBacktracking dames = new DamesBacktracking(new int[] { 0 });
		assertTrue(dames.next(1));
	}

	@Test
	public void next3() throws Exception {
		DamesBacktracking dames = new DamesBacktracking(new int[] { 1, 2, 3 });
	...
	public void checkConflicts_diagonal() throws Exception {
		DamesBacktracking dames = new DamesBacktracking(new int[] { 1, 2, 3, 0 });
	...
	public void checkConflicts_3inRow() throws Exception {
		DamesBacktracking dames = new DamesBacktracking(new int[] { 1, 0, 2, 0, 8 });
		assertFalse(dames.checkConflicts(4, 3));

		dames = new DamesBacktracking(new int[] { 5, 0, 4, 0, 8 });
		assertFalse(dames.checkConflicts(4, 3));
	}
	...
	public void randomSolutions() throws Exception {
		...
		int[] board0 = new DamesBacktracking(9).getBoard();
		int[] board1 = new DamesBacktracking(9).getBoard();
